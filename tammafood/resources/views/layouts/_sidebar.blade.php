        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                ...
                <ul id="side-menu" class="nav">
                    ...
                    <li class="menu-primer {{Request::is('purchasing') ? 'active' : '' || Request::is('purchasing/*') ? 'active' : '' }}"><a href="#"><i class="fa fa-credit-card fa-fw">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="menu-sekunder {{ Request::is('purchasing/rencanapembelian/rencana') ? 'active' : '' || Request::is('purchasing/rencanapembelian/*') ? 'active' : '' }}">
                    ...
                    <!-- ======= -->
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            || Request::is('penjualan/pos-penjualan-toko/*') ? 'active' : ''
                            ...
                            <li class="menu-sekunder {{ Request::is('penjualan/POSpenjualanpesanan/POSpenjualanpesanan') ? 'active' : '' || Request::is('penjualan/POSpenjualanpesanan/*') ? 'active' : '' }}"><a href="{{ url('/penjualan/POSpenjualanpesanan/POSpenjualanpesanan') }}"><span class="submenu-title">POS Penjualan Pesanan</span><span class="hidden">Penjualan</span></a>
                            </li>
                    ...
                    Recruitment</span>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="menu-sekunder {{ Request::is('hrd/datajabatan/datajabatan') ? 'active' : '' || Request::is('hrd/datajabatan/*') ? 'active' : '' }}"> <a href="{{ url('/hrd/datajabatan/datajabatan')}}"> <span class="submenu-title"> Data Jabatan </span> <span class="hidden">HRD</span></a>
                            </li>
