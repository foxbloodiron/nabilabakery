        ...
        <table class="table" id="tablePayment">
          <tbody class="mc">
            <tr>
              ...
              <td>
                <input type="text" name="sp_nominal[]" id="bayar" value="" class="i_price form-control total bandingPayment totPayment" onkeyup="updateKembalian()" style="text-align: right;" onkeyup="rege(event,'i_price');" onblur="setRupiah(event,'i_price')" onclick="setAwal('event','i_price')" >
              </td>
              <td>
