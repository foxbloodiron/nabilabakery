        ...
        <tbody>
          ...
          <tr>
            ...
            <td><div class="input-group">
              <input type="text" style="text-align:right" class="form-control discpercent" name="sd_disc_percent[]"  value="{{ $x->sd_disc_percent }}" onkeyup="discpercent(this, event)"><span class="input-group-addon">%</span></div>
            </td>
            <td><input type="text" style="text-align:right" class="form-control discvalue" name="sd_disc_value[]"  value="{{ $x->sd_disc_value }}" onkeyup="discvalue(this, event)">
            </td>
            <td >
