...
class POSMobilController extends Controller
{
  public function mobil(){	
    ...
    if ($maxid < 100) {
      ...
      return view('/penjualan/POStoko/index',compact('id_cust','fatkur', 'idreq','stock','dataPayment', 'ket'));
    }
  ...
  public function edit_sales($id){
    ...
    return view('/penjualan/POStoko/index',compact('id_cust','fatkur','idreq', 'stock','edit','dataPayment', 'ket'));
  }
  ...
  public function detail(Request $request){
   ...
   return view('/penjualan/POStoko/NotaPenjualan.detail',compact('detaliss'));
  }
  ...
  public function distroy($id){
   ...
   return redirect('/penjualan/POStoko/index');
  }
  ...
  public function getTanggal($tgl1,$tgl2){
    ...
    return view('/penjualan/POStoko/NotaPenjualan.dt_notaJual',compact('detalis'));
  }
  ...
  function getTanggalJual($tgl1,$tgl2){
    ...
    $leagues = DB::table('d_sales_dt')
      ...
      return view('/penjualan/POStoko/ItemPenjualan.Data_JualRetail',compact('leagues'));
      }
