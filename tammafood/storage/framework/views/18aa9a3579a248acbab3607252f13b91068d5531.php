                ...
                <div class="page-content fadeInRight">
                    <div id="tab-general">
                        ...
                        <div id="generalTabContent" class="tab-content responsive">
                          ...
                          <?php echo $__env->make('purchasing.orderpembelian.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                ...
                                <div id="alert-tab" class="tab-pane fade in active">
                                  ...
                                  <div class="row" style="margin-top: -10px;">
                                    <div class="col-md-12 col-sm-12 col-xs-12" >
                                      ...
                                      <div align="right">
                                        <a href="<?php echo e(url('/purchasing/orderpembelian/tambah_order')); ?>" class="btn btn-box-tool" style="margin-bottom: 10px;"><i class="fa fa-plus"></i>&nbsp;Tambah Order</a>
