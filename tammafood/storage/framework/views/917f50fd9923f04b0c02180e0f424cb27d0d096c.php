...
<div id="nav-stock" class="tab-pane fade">
  ...
  <!-- Modal -->
  <?php echo $__env->make('penjualan.POSretail.StokRetail.transfer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <!-- End modal -->

  <!-- Modal Edit stock-->
  <?php echo $__env->make('penjualan.POSretail.StokRetail.edit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <!-- End modal -->
  ...
  <div class="row" style="margin-top: 15px;">
    <div class="col-md-12 col-sm-12 col-xs-12">
       ...
       <?php if(Auth::user()->punyaAkses('Ritail Transfer','ma_insert')): ?>
