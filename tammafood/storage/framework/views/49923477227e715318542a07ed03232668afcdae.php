...
<style type="text/css">
  td.details-control {
    background: url(<?php echo e(asset('assets/images/details_open.png')); ?>) no-repeat center center;
    cursor: pointer;
}
 .sorting_disabled {
...
tr.details td.details-control {
     background: url(<?php echo e(asset('assets/images/details_close.png')); ?>) no-repeat center center;
}
...
/*tr.details td.details-control {
  ...
  <div align="right" class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:10px;">
    ...
    <a href="<?php echo e(url('master/datacust/tambah_cust')); ?>"><button type="button" class="btn btn-box-tool" title="Tambahkan Data Item">
