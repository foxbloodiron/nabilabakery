                                ...
                                <div class="col-md-8 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                    <div class="input-icon right">
                                      ...
                                      value="<?php echo e(Auth::user()->m_name); ?>"> 
                                      <input type="hidden" id="" readonly="true" name="ri_admin" class="form-control input-sm" value="<?php echo e(Auth::user()->m_id); ?>">      
                                    </div>                           
                                  </div>
                                </div>
                                <div class="col-md-4 col-sm-3 col-xs-12">
                                ...
                                <div class="col-md-8 col-sm-9 col-xs-12">
                                  <div class="form-group">
                                    <div class="input-icon right">
                                      ...
                                      <input type="text" readonly="true" name="ri_tanggal" class="form-control input-sm" value="<?php echo e(date('d-m-Y')); ?>">
                                    </div>                                
                                  </div>
                                </div>
                                <div class="col-md-4 col-sm-3 col-xs-12">
